      ...
      0003B6                        111 DELAY1:
      0003B6 AC 83            [24]  112 	MOV R4,dph
      0003B8                        113 DELAY3:
      0003B8 0C               [12]  114 	INC R4
      0003B9                        115 DELAY4:
      0003B9 AD 82            [24]  116 	MOV R5,dpl
      0003BB                        117 DL1:
      0003BB 7E 03            [12]  118 	MOV R6,#3
      0003BD                        119 DL2:
      0003BD 7F AA            [12]  120 	MOV R7,#170
      0003BF                        121 DL3:
      0003BF DF FE            [24]  122 	DJNZ R7,DL3
      0003C1 DE FA            [24]  123 	DJNZ	R6,DL2
      0003C3 DD F6            [24]  124 	DJNZ	R5,DL1
      0003C5 DC F2            [24]  125 	DJNZ	R4,DELAY4
                                    126 ;	./src/delay.c:17: }
      0003C7 22               [24]  127 	ret
                                    128 ;------------------------------------------------------------
                                    129 ;Allocation info for local variables in function 'Delay'
                                    130 ;------------------------------------------------------------
                                    131 ;i                         Allocated to registers r7 
                                    132 ;------------------------------------------------------------
                                    133 ;	./src/delay.c:19: void Delay(void)
                                    134 ;	-----------------------------------------
                                    135 ;	 function Delay
                                    136 ;	-----------------------------------------
      0003C8                        137 _Delay:
                                    138 ;	./src/delay.c:22: for (i = 0; i < 5; i++);
      0003C8 7F 05            [12]  139 	mov	r7,#0x05
      0003CA                        140 00104$:
      0003CA DF FE            [24]  141 	djnz	r7,00104$
                                    142 ;	./src/delay.c:23: }
      0003CC 22               [24]  143 	ret
                                    144 	.area CSEG    (CODE)
                                    145 	.area CONST   (CODE)
                                    146 	.area XINIT   (CODE)
