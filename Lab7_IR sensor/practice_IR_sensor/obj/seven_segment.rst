      ...
      0002D2                        301 _sendbyte:
                           ...
                           000001   308 	ar1 = 0x01
                           000000   309 	ar0 = 0x00
      0002D2 AF 82            [24]  310 	mov	r7,dpl
                                    311 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      0002D4 7E 00            [12]  312 	mov	r6,#0x00
      0002D6                        313 00103$:
                                    314 ;	./src/seven_segment.c:9: CLK = 0;
                                    315 ;	assignBit
      0002D6 C2 A0            [12]  316 	clr	_P2_0
                                    317 ;	./src/seven_segment.c:10: DIN = (address & 0x80);
      0002D8 EF               [12]  318 	mov	a,r7
      0002D9 23               [12]  319 	rl	a
      0002DA 54 01            [12]  320 	anl	a,#0x01
                                    321 ;	assignBit
      0002DC 24 FF            [12]  322 	add	a,#0xff
      0002DE 92 A1            [24]  323 	mov	_P2_1,c
                                    324 ;	./src/seven_segment.c:11: address <<= 1;
      0002E0 8F 05            [24]  325 	mov	ar5,r7
      0002E2 ED               [12]  326 	mov	a,r5
      0002E3 2D               [12]  327 	add	a,r5
      0002E4 FF               [12]  328 	mov	r7,a
                                    329 ;	./src/seven_segment.c:12: CLK = 1;
                                    330 ;	assignBit
      0002E5 D2 A0            [12]  331 	setb	_P2_0
                                    332 ;	./src/seven_segment.c:7: for (i=0; i<8; i++)
      0002E7 0E               [12]  333 	inc	r6
      0002E8 BE 08 00         [24]  334 	cjne	r6,#0x08,00123$
      0002EB                        335 00123$:
      0002EB 40 E9            [24]  336 	jc	00103$
                                    337 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      0002ED 7F 00            [12]  338 	mov	r7,#0x00
      0002EF                        339 00105$:
                                    340 ;	./src/seven_segment.c:17: CLK = 0;
                                    341 ;	assignBit
      0002EF C2 A0            [12]  342 	clr	_P2_0
                                    343 ;	./src/seven_segment.c:18: DIN = (dat & 0x80);
      0002F1 E5 1A            [12]  344 	mov	a,_sendbyte_PARM_2
      0002F3 23               [12]  345 	rl	a
      0002F4 54 01            [12]  346 	anl	a,#0x01
                                    347 ;	assignBit
      0002F6 24 FF            [12]  348 	add	a,#0xff
      0002F8 92 A1            [24]  349 	mov	_P2_1,c
                                    350 ;	./src/seven_segment.c:19: dat <<= 1;
      0002FA E5 1A            [12]  351 	mov	a,_sendbyte_PARM_2
      0002FC 25 E0            [12]  352 	add	a,acc
      0002FE F5 1A            [12]  353 	mov	_sendbyte_PARM_2,a
                                    354 ;	./src/seven_segment.c:20: CLK = 1;
                                    355 ;	assignBit
      000300 D2 A0            [12]  356 	setb	_P2_0
                                    357 ;	./src/seven_segment.c:15: for (i=0; i<8; i++)
      000302 0F               [12]  358 	inc	r7
      000303 BF 08 00         [24]  359 	cjne	r7,#0x08,00125$
      000306                        360 00125$:
      000306 40 E7            [24]  361 	jc	00105$
                                    362 ;	./src/seven_segment.c:22: }
      000308 22               [24]  363 	ret
                                    364 ;------------------------------------------------------------
                                    ...
                                    374 ;	-----------------------------------------
      000309                        375 _Write7219:
      000309 AF 82            [24]  376 	mov	r7,dpl
                                    377 ;	./src/seven_segment.c:27: LOAD_MAX = 0;
                                    378 ;	assignBit
      00030B C2 A4            [12]  379 	clr	_P2_4
                                    380 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      00030D 7E 01            [12]  381 	mov	r6,#0x01
      00030F                        382 00102$:
                                    383 ;	./src/seven_segment.c:30: sendbyte(address, dat);
      00030F 85 19 1A         [24]  384 	mov	_sendbyte_PARM_2,_Write7219_PARM_2
      000312 8F 82            [24]  385 	mov	dpl,r7
      000314 C0 07            [24]  386 	push	ar7
      000316 C0 06            [24]  387 	push	ar6
      000318 12 02 D2         [24]  388 	lcall	_sendbyte
      00031B D0 06            [24]  389 	pop	ar6
      00031D D0 07            [24]  390 	pop	ar7
                                    391 ;	./src/seven_segment.c:28: for(cnt=1; cnt<=matrixnum; cnt++)
      00031F 0E               [12]  392 	inc	r6
      000320 EE               [12]  393 	mov	a,r6
      000321 24 FE            [12]  394 	add	a,#0xff - 0x01
      000323 50 EA            [24]  395 	jnc	00102$
                                    396 ;	./src/seven_segment.c:32: LOAD_MAX = 1;
                                    397 ;	assignBit
      000325 D2 A4            [12]  398 	setb	_P2_4
                                    399 ;	./src/seven_segment.c:33: }
      000327 22               [24]  400 	ret
                                    401 ;------------------------------------------------------------
      ...
      000328 75 19 01         [24]  412 	mov	_Write7219_PARM_2,#0x01
      00032B 75 82 0C         [24]  413 	mov	dpl,#0x0c
      00032E 12 03 09         [24]  414 	lcall	_Write7219
                                    415 ;	./src/seven_segment.c:39: Write7219(DISPLAY_TEST, 0x00);
      000331 75 19 00         [24]  416 	mov	_Write7219_PARM_2,#0x00
      000334 75 82 0F         [24]  417 	mov	dpl,#0x0f
      000337 12 03 09         [24]  418 	lcall	_Write7219
                                    419 ;	./src/seven_segment.c:40: Write7219(DECODE_MODE, 0x00);
      00033A 75 19 00         [24]  420 	mov	_Write7219_PARM_2,#0x00
      00033D 75 82 09         [24]  421 	mov	dpl,#0x09
      000340 12 03 09         [24]  422 	lcall	_Write7219
                                    423 ;	./src/seven_segment.c:41: Write7219(SCAN_LIMIT, 0x07);
      000343 75 19 07         [24]  424 	mov	_Write7219_PARM_2,#0x07
      000346 75 82 0B         [24]  425 	mov	dpl,#0x0b
      000349 12 03 09         [24]  426 	lcall	_Write7219
                                    427 ;	./src/seven_segment.c:42: Write7219(INTENSITY, 0x01);
      00034C 75 19 01         [24]  428 	mov	_Write7219_PARM_2,#0x01
      00034F 75 82 0A         [24]  429 	mov	dpl,#0x0a
      000352 12 03 09         [24]  430 	lcall	_Write7219
                                    431 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      000355 7F 01            [12]  432 	mov	r7,#0x01
      000357                        433 00102$:
                                    434 ;	./src/seven_segment.c:45: Write7219(i, 0x00);
      000357 75 19 00         [24]  435 	mov	_Write7219_PARM_2,#0x00
      00035A 8F 82            [24]  436 	mov	dpl,r7
      00035C C0 07            [24]  437 	push	ar7
      00035E 12 03 09         [24]  438 	lcall	_Write7219
      000361 D0 07            [24]  439 	pop	ar7
                                    440 ;	./src/seven_segment.c:44: for(i=1; i<=8; i++){
      000363 0F               [12]  441 	inc	r7
      000364 EF               [12]  442 	mov	a,r7
      000365 24 F7            [12]  443 	add	a,#0xff - 0x08
      000367 50 EE            [24]  444 	jnc	00102$
                                    445 ;	./src/seven_segment.c:47: }
      000369 22               [24]  446 	ret
                                    447 	.area CSEG    (CODE)
                                    448 	.area CONST   (CODE)
                                    449 	.area XINIT   (CODE)
