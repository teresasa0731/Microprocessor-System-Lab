...
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
;	./src/main.c:10: unsigned char seg[] = {
	mov	_main_seg_65536_9,#0xb0
	mov	(_main_seg_65536_9 + 0x0001),#0xed
	mov	(_main_seg_65536_9 + 0x0002),#0xf9
	mov	(_main_seg_65536_9 + 0x0003),#0xb3
	mov	(_main_seg_65536_9 + 0x0004),#0xdb
	mov	(_main_seg_65536_9 + 0x0005),#0xdf
	mov	(_main_seg_65536_9 + 0x0006),#0xf0
	mov	(_main_seg_65536_9 + 0x0007),#0xff
;	./src/main.c:22: unsigned char hi[] = {
...
;	./src/main.c:44: Initial();               //MAX7219 initialize
	lcall	_Initial
;	./src/main.c:46: while(1) {
00102$:
;	./src/main.c:48: Write7219(2,0xFF);
