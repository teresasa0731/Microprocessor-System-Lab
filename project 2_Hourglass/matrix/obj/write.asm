...
;------------------------------------------------------------
;	./src/write.c:7: void Write7219(unsigned char address, unsigned char dat)
;	-----------------------------------------
;	 function Write7219
;	-----------------------------------------
_Write7219:
...
;------------------------------------------------------------
;	./src/write.c:19: void Writesingle7219(unsigned char chosen, unsigned char address, unsigned char dat)
;	-----------------------------------------
;	 function Writesingle7219
;	-----------------------------------------
_Writesingle7219:
	mov	r7,dpl
;	./src/write.c:22: LOAD = 0;
;	assignBit
	clr	_P2_1
;	./src/write.c:23: for(cnt=matrixnum; cnt>chosen; cnt--) { //write data into the selected matrix
	mov	r6,#0x02
00104$:
	clr	c
	mov	a,r7
	subb	a,r6
	jnc	00101$
;	./src/write.c:24: sendbyte(0x00, 0x00);               //write 0 to no-op
...
;	./src/write.c:23: for(cnt=matrixnum; cnt>chosen; cnt--) { //write data into the selected matrix
	...
	sjmp	00104$
00101$:
;	./src/write.c:26: sendbyte(address, dat);             //sent data to chosen led-matrix
	mov	_sendbyte_PARM_2,_Writesingle7219_PARM_3
	mov	dpl,_Writesingle7219_PARM_2
	push	ar7
	lcall	_sendbyte
	pop	ar7
;	./src/write.c:28: for (cnt=chosen-1; cnt>=1; cnt--) {
	dec	r7
00107$:
	cjne	r7,#0x01,00130$
00130$:
	jc	00102$
;	./src/write.c:29: sendbyte(0x00, 0x00);               //write 0 to no-op
	mov	_sendbyte_PARM_2,#0x00
	mov	dpl,#0x00
	push	ar7
	lcall	_sendbyte
