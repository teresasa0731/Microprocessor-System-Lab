...
;------------------------------------------------------------
;	./src/i2c.c:12: void I2C_Start(void)
;	-----------------------------------------
;	 function I2C_Start
;	-----------------------------------------
_I2C_Start:
...
;------------------------------------------------------------
;	./src/i2c.c:23: void I2C_Stop(void)
;	-----------------------------------------
;	 function I2C_Stop
;	-----------------------------------------
_I2C_Stop:
...
;------------------------------------------------------------
;	./src/i2c.c:33: void I2C_SendACK(__bit ack)
;	-----------------------------------------
;	 function I2C_SendACK
;	-----------------------------------------
_I2C_SendACK:
;	./src/i2c.c:35: SDA = ack;
;	assignBit
...
;------------------------------------------------------------
;	./src/i2c.c:43: __bit I2C_RecvACK(void)
;	-----------------------------------------
...
;------------------------------------------------------------
;	./src/i2c.c:54: void I2C_SendByte(uint8_t dat)
;	-----------------------------------------
;	 function I2C_SendByte
;	-----------------------------------------
_I2C_SendByte:
	mov	r7,dpl
;	./src/i2c.c:57: for (i=0; i<8; i++)
	mov	r6,#0x00
00102$:
;	./src/i2c.c:59: dat <<= 1;
	mov	ar5,r7
...
;------------------------------------------------------------
;	./src/i2c.c:70: uint8_t I2C_RecvByte(void)
;	-----------------------------------------
;	 function I2C_RecvByte
;	-----------------------------------------
_I2C_RecvByte:
;	./src/i2c.c:73: uint8_t dat = 0;
	mov	r7,#0x00
;	./src/i2c.c:74: SDA = 1;
;	assignBit
	setb	_P0_1
;	./src/i2c.c:75: for (i=0; i<8; i++)
	mov	r6,#0x00
00102$:
;	./src/i2c.c:77: dat <<= 1;
	mov	ar5,r7
...
;------------------------------------------------------------
;	./src/i2c.c:88: void Single_WriteI2C(uint8_t SlaveAddress, uint8_t REG_Address,uint8_t REG_data)
;	-----------------------------------------
;	 function Single_WriteI2C
;	-----------------------------------------
_Single_WriteI2C:
	mov	r7,dpl
;	./src/i2c.c:90: I2C_Start();
	push	ar7
	lcall	_I2C_Start
	pop	ar7
;	./src/i2c.c:91: I2C_SendByte(SlaveAddress);
	mov	dpl,r7
	lcall	_I2C_SendByte
;	./src/i2c.c:92: I2C_SendByte(REG_Address);
	mov	dpl,_Single_WriteI2C_PARM_2
	lcall	_I2C_SendByte
;	./src/i2c.c:93: I2C_SendByte(REG_data);
	mov	dpl,_Single_WriteI2C_PARM_3
	lcall	_I2C_SendByte
;	./src/i2c.c:94: I2C_Stop();
;	./src/i2c.c:95: }
	ljmp	_I2C_Stop
;------------------------------------------------------------
...
;------------------------------------------------------------
;	./src/i2c.c:98: uint8_t Single_ReadI2C(uint8_t SlaveAddress, uint8_t REG_Address)
;	-----------------------------------------
;	 function Single_ReadI2C
;	-----------------------------------------
_Single_ReadI2C:
	mov	r7,dpl
;	./src/i2c.c:101: I2C_Start();
	push	ar7
	lcall	_I2C_Start
	pop	ar7
;	./src/i2c.c:102: I2C_SendByte(SlaveAddress);
	mov	dpl,r7
	push	ar7
	lcall	_I2C_SendByte
;	./src/i2c.c:103: I2C_SendByte(REG_Address);
	mov	dpl,_Single_ReadI2C_PARM_2
	lcall	_I2C_SendByte
;	./src/i2c.c:104: I2C_Stop();
	lcall	_I2C_Stop
;	./src/i2c.c:106: I2C_Start();
	lcall	_I2C_Start
	pop	ar7
;	./src/i2c.c:107: I2C_SendByte(SlaveAddress|0x01);  // R/W#: 1 means read mode
	mov	a,#0x01
	orl	a,r7
	mov	dpl,a
	lcall	_I2C_SendByte
;	./src/i2c.c:108: REG_data=I2C_RecvByte();
	lcall	_I2C_RecvByte
	mov	r7,dpl
;	./src/i2c.c:109: I2C_SendACK(1);
;	assignBit
	setb	_I2C_SendACK_PARM_1
	push	ar7
	lcall	_I2C_SendACK
;	./src/i2c.c:110: I2C_Stop();
	lcall	_I2C_Stop
	pop	ar7
;	./src/i2c.c:111: return REG_data;
	mov	dpl,r7
;	./src/i2c.c:112: }
	ret
	.area CSEG    (CODE)
