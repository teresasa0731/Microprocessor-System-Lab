...
;prebut1                   Allocated to registers r5 r6 
;prebut2                   Allocated to registers r3 r4 
;mode                      Allocated to registers r1 r2 
;------------------------------------------------------------
...
;	./src/main.c:35: patt = 0x80;
	...
	sjmp	00116$
00111$:
;	./src/main.c:38: patt = patt >> 2;
	mov	a,r7
	rr	a
	rr	a
	anl	a,#0x3f
;	./src/main.c:39: if(patt == 0x00)	// reset
	mov	r7,a
	jnz	00116$
;	./src/main.c:40: patt = 0x80;
	mov	r7,#0x80
00116$:
...
;	./src/main.c:48: if(but2 == 0) {
	jb	_P2_1,00128$
;	./src/main.c:49: if(mode == 0) {
	mov	a,r1
	orl	a,r2
	jnz	00123$
;	./src/main.c:50: patt = patt << 1;
	mov	ar0,r7
	mov	a,r0
	add	a,r0
;	./src/main.c:51: if(patt == 0x00)
	mov	r7,a
	jnz	00128$
;	./src/main.c:52: patt = 0x01;
	mov	r7,#0x01
	sjmp	00128$
00123$:
;	./src/main.c:55: patt = patt << 2;
	mov	ar0,r7
	mov	a,r0
	add	a,r0
;	./src/main.c:56: if(patt == 0x00)
	add	a,acc
	mov	r7,a
	jnz	00128$
;	./src/main.c:57: patt = 0x01;
	mov	r7,#0x01
00128$:
;	./src/main.c:62: led =~ patt;	
	mov	a,r7
	cpl	a
	mov	_P1,a
;	./src/main.c:63: prebut1 = but1;
	mov	c,_P2_0
	clr	a
	rlc	a
	mov	r5,a
	mov	r6,#0x00
;	./src/main.c:64: prebut2 = but2;
	mov	c,_P2_1
	clr	a
	rlc	a
	mov	r3,a
	mov	r4,#0x00
;	./src/main.c:65: delay_ms(10);
	mov	dptr,#0x000a
	push	ar7
	push	ar6
	push	ar5
